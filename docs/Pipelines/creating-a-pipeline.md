...
<Callout icon="💡" theme="info">
  Hive-built pipelines are created **already active** — the public application link works immediately. Review the generated steps and [assessment](/docs/creating-editing-assessments) before you share the link widely.
</Callout>
...
<Callout icon="⚠️" theme="warn">
  Connect a mailbox in **Settings → Email Services** before activating — automated candidate emails can't send without one. See [Email Integration & Inbox](/docs/email-integration-inbox).
</Callout>
