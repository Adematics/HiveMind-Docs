...
| **Skills** | Sends one of your [assessments](/docs/assessments-overview) — technical challenges or custom topics. | Verifying the abilities the role actually requires. |
