...
Once a pipeline is live, candidates flow through it on their own. Your job is to watch progress, clear review checkpoints, and occasionally move someone by hand. This page covers the applicants table and the tools you have for steering individual applicants.

## 1. Open the applicants table
