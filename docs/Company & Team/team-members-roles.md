...
Open **Settings → Roles**. Hivemind ships with seven ready-made **System Roles** — **Admin**, **Recruiter**, **Hiring Manager**, **Interviewer**, **Sourcer**, **Developer**, and **Viewer** — each with a curated permission set and a member count so you can see who's on what. System roles can't be edited; they're a stable foundation.
